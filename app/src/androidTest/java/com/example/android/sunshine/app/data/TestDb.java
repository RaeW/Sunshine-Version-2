...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("something happened", data.moveToFirst());
        assertTrue(data.getCount() == 1);
        assertTrue(data.getString(data.getColumnIndex("city_name")).equals("North Pole"));


        // Validate data in resulting Cursor with the original ContentValues
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("Location query validation failed", data, contentValues);
    ...
    public void testWeatherTable() {
        ...
        // Query the database and receive a Cursor back
        Cursor data = db.query(WeatherContract.WeatherEntry.TABLE_NAME, null, null, null, null, null, null);
        // Move the cursor to a valid database row
        data.moveToFirst();
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        validateCurrentRecord("Weather data is invalid", data, contentValues);
        assertTrue(data.getLong(data.getColumnIndex("date")) == 1419033600L);
        // Finally, close the cursor and database
        data.close();
        db.close();
    }
